...
/**
 * The panel's contents, without the sheet around them — the photo counterpart of
 * `EditMetadataPanel`, for callers that fetch the record before they can render
 * it (see that component for why).
 */
export function ImageEditPanel({
  ...
  const detail = trpc.media.getImage.useQuery({ imageId: image.id });
